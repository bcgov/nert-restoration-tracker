...
CREATE TABLE project(
    ...
    is_healing_land        boolean           DEFAULT false NOT NULL,
    is_healing_people      boolean           DEFAULT false NOT NULL,
    is_land_initiative     boolean           DEFAULT false NOT NULL,
    is_cultural_initiative boolean           DEFAULT false NOT NULL,
