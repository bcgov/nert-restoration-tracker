...
describe('viewUserReportApp', () => {
  ...
  it('should return Pi Report App Data', async () => {
    ...
    const requestHandler = view.viewUserReportApp();
    ...
    sinon.stub(ReportService.prototype, 'getAppUserReport').resolves([]);
  ...
  it('should catch and rethrow error', async () => {
    ...
    sinon.stub(db, 'getDBConnection').returns(dbConnectionObj);
    sinon.stub(ReportService.prototype, 'getAppUserReport').throws(new Error('An error occurred'));
