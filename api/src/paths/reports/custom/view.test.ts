...
describe('viewCustomReportApp', () => {
  ...
  it('should return Pi Report App Data', async () => {
    ...
    const requestHandler = view.viewCustomReportApp();
    ...
    sinon.stub(ReportService.prototype, 'getCustomReport').resolves([]);
  ...
  it('should catch and rethrow error', async () => {
    ...
    sinon.stub(db, 'getDBConnection').returns(dbConnectionObj);
    sinon.stub(ReportService.prototype, 'getCustomReport').throws(new Error('An error occurred'));
