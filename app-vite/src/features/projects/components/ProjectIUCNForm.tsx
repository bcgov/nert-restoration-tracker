...
export interface IIUCNSubClassification1Option
  extends IMultiAutocompleteFieldOption {
  iucn1_id: number;
}

export interface IIUCNSubClassification2Option
  extends IMultiAutocompleteFieldOption {
  iucn2_id: number;
}
    ...
    classificationDetails: yup
      ...
      .of(
        yup.object().shape({
          classification: yup
            .number()
            .required("You must specify a classification"),
          subClassification1: yup
            .number()
            .required("You must specify a sub-classification"),
          subClassification2: yup
            .number()
            .required("You must specify a sub-classification"),
        })
      )
    ...
    <>
      ...
      <Box mb={3} maxWidth={"72ch"}>
        <Typography variant="body1" color="textSecondary">
          Conservation actions are specific actions or sets of tasks undertaken
          by project staff designed to reach each of the project's objectives.
          <Button
            color="primary"
      ...
      <FieldArray
        ...
        render={(arrayHelpers: any) => (
          <Box>
            {values.iucn.classificationDetails.map(
              (classificationDetail, index) => {
                ...
                return (
                  ...
                  >
                    <Box
                      display="flex"
                      alignItems="center"
                      sx={pageStyles.iucnInputContainer}
                      mr={1}
                    >
                      <Box sx={pageStyles.iucnInput} py={1}>
                        ...
                        >
                          ...
                          <Select
                            ...
                            error={
                              classificationMeta.touched &&
                              Boolean(classificationMeta.error)
                            }
                      ...
                      <Box sx={pageStyles.iucnInput} py={1}>
                        <FormControl
                          ...
                          required={true}
                        >
                          <InputLabel id="subClassification1">
                            Sub-classification
                          </InputLabel>
                          <Select
                            ...
                            error={
                              subClassification1Meta.touched &&
                              Boolean(subClassification1Meta.error)
                            }
                      ...
                      <Box sx={pageStyles.iucnInput} py={1}>
                        <FormControl
                          ...
                          required={true}
                        >
                          <InputLabel id="subClassification2">
                            Sub-classification
                          </InputLabel>
                          <Select
                            ...
                            error={
                              subClassification2Meta.touched &&
                              Boolean(subClassification2Meta.error)
                            }
            ...
            <Box>
              <Button
                ...
                onClick={() =>
                  arrayHelpers.push(ProjectIUCNFormArrayItemInitialValues)
                }
              >
                Add Classification
              </Button>
      ...
      >
        <Typography variant="body1">
          The taxonomies presented here began with a collaborative effort
          between the World Conservation Union (IUCN) and CMP to create standard
          classifications of the conservation actions biologist and other
          conservation actors can take to counter threats to species and
          ecosystem conservation.
          <br></br>
          <br></br>
          This classification is designed to provide a simple, hierarchical,
          comprehensive, consistent, expandable, exclusive, and scalable
          classification of all conservation actions.
          <br></br>
          <br></br>
          The classifications are intended to:
          <ul>
            <li>
              Help conservation teams describe what is happening at their site.
            </li>
            <li>
              A common classification of conservation actions which enables
              practitioners to search a database of conservation projects and
              find projects using similar actions.
            </li>
            <li>
              Create general summaries or “roll-ups” for broader organizational
              purposes and/or use by senior managers, researcher, NGOs, etc.
              Summaries can tally the frequency of actions across projects at
              various organizational scales or be combined with other
          ...
          <Button
            ...
            data-testid="prop-dialog-btn"
            onClick={() =>
              openAttachment(ICUN_CONSERVATION_CLASSIFICATION_REFERENCE_URL)
            }
          >
            <Typography component="span">
              Download CMP Classificiations
            </Typography>
          </Button>
        </Typography>
      </ComponentDialog>
